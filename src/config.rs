...
pub use self::{
    ...
    model::{
        ...
        ShellModeConfig, SidebarCollapsedModeConfig, SidebarPositionConfig, StatusIndicatorStyle,
        TabBarPositionConfig, TabStatusOrderConfig, ToastClipboardPosition, ToastConfig,
